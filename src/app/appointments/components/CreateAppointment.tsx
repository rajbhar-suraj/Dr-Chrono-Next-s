...
const appointmentDetails = [
  { name: "start_date_time", label: "Start Date & Time", placeholder: "2025-09-17 09:00" },
  { name: "end_date_time", label: "End Date & Time", placeholder: "2025-09-17 09:30" },
  { name: "pt_id", label: "Patient ID", placeholder: "1" },
  { name: "provider_ids", label: "Provider IDs", placeholder: "1,2" },
  { name: "appointment_type", label: "Appointment Type", placeholder: "Preventative Care" },
  { name: "title", label: "Title", placeholder: "Follow-up Meeting" },
  { name: "appointment_note", label: "Notes", placeholder: "Notes about the appointment" },
  { name: "status", label: "Status", placeholder: "scheduled / confirmed / cancelled" },
  { name: "telemedicine", label: "Telemedicine", placeholder: "true / false" },
];
